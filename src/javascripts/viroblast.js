...
//	alert ("value: "+value);
	...
	if (value == "Advanced search") {
		...
		if (form.OTHER_ADVANCED.value) {
			...
			alert("advance "+advancedStr);
			if (!advancedStr.match(/^\s+$/) && !advancedStr.match(/^\s*\-[A-Za-z]/)) {
				alert ("Other parameters field must start with \"-\" followed by options");
				submitForm = false;
				return;
			}
			if (!advancedStr.match(/^[ \-\w]*$/)) {
				alert ("The format of other parameters field may be not correct, please check BLAST+ usage.");
				submitForm = false;
				return;
			}
		}
...
function changeDBList (value, dbListObj) {
	removeChildNodes (dbListObj);
	if (value == "blastn" || value == "tblastn" || value == "tblastx" || value == "megablast") {
		var dbOption1 = document.createElement("option");
		dbOption1.setAttribute("value", "Viroverse");
		dbOption1.appendChild(document.createTextNode("Viroverse Public"));
		var dbOption2 = document.createElement("option");
		dbOption2.setAttribute("value", "Genbank");
		dbOption2.appendChild(document.createTextNode("Viral Genbank"));
		var dbOption3 = document.createElement("option");
		dbOption3.setAttribute("value", "hiv");
		dbOption3.appendChild(document.createTextNode("HIV Genbank"));
/*		var dbOption4 = document.createElement("option");
		dbOption4.setAttribute("value", "HumanGenome");
		dbOption4.appendChild(document.createTextNode("Human Genome (082905)"));
		var dbOption5 = document.createElement("option");
		dbOption5.setAttribute("value", "chimpanzee");
		dbOption5.appendChild(document.createTextNode("Pan Troglodytes Genome (121004)"));*/
		var dbOption6 = document.createElement("option");
		dbOption6.setAttribute("value", "LanlCompletegenome");
		dbOption6.appendChild(document.createTextNode("LANL HIV-1 Complete Genome (2017)"));
		var dbOption7 = document.createElement("option");
		dbOption7.setAttribute("value", "Lanlsubtyperef");
		dbOption7.appendChild(document.createTextNode("LANL HIV-1 Subtype Reference (2010)"));
		var dbOption8 = document.createElement("option");
		dbOption8.setAttribute("value", "LanlConsensus");
		dbOption8.appendChild(document.createTextNode("LANL HIV-1 Consensus & Ancestor (2002)"));
		var dbOption9 = document.createElement("option");
		dbOption9.setAttribute("value", "UniVec");
		dbOption9.appendChild(document.createTextNode("Vectors"));
//		dbListObj.appendChild(dbOption1);
		dbListObj.appendChild(dbOption3);
		dbListObj.appendChild(dbOption2);
/*		dbListObj.appendChild(dbOption4);
		dbListObj.appendChild(dbOption5);*/
		dbListObj.appendChild(dbOption6);
		dbListObj.appendChild(dbOption7);
		dbListObj.appendChild(dbOption8);
		dbListObj.appendChild(dbOption9);
	}else {
		var dbOption0 = document.createElement("option");
		dbOption0.setAttribute("value", "nr");
		dbOption0.appendChild(document.createTextNode("nr"));
		var dbOption1 = document.createElement("option");
		dbOption1.setAttribute("value", "ViroProt");
		dbOption1.appendChild(document.createTextNode("Viral protein"));
		var dbOption2 = document.createElement("option");
		dbOption2.setAttribute("value", "HIVProt");
		dbOption2.appendChild(document.createTextNode("HIV protein"));
		var dbOption3 = document.createElement("option");
		dbOption3.setAttribute("value", "HumanProt");
		dbOption3.appendChild(document.createTextNode("Human proteom"));
		var dbOption4 = document.createElement("option");
		dbOption4.setAttribute("value", "ChimProt");
		dbOption4.appendChild(document.createTextNode("Pan Troglodytes proteom"));
		var dbOption5 = document.createElement("option");
		dbOption5.setAttribute("value", "SwissProt");
		dbOption5.appendChild(document.createTextNode("SwissProt"));
		var dbOption6 = document.createElement("option");
		dbOption6.setAttribute("value", "RefSeqProt");
		dbOption6.appendChild(document.createTextNode("RefSeq"));
//		dbListObj.appendChild(dbOption0);
		dbListObj.appendChild(dbOption2);
		dbListObj.appendChild(dbOption1);		
//		dbListObj.appendChild(dbOption3);
//		dbListObj.appendChild(dbOption4);
...
function changeParameters(value, parameters) {
	...
	targetOptions[4] = 250;
	targetOptions[5] = 500;
	targetOptions[6] = 1000;
	targetOptions[7] = 5000;
	targetOptions[8] = 10000;
	...
	if (value == 'blastn' || value == 'megablast') {
		...
		for (var i = 0; i < mmScoreOptions.length; i++) {
			...
			if (value == 'blastn' && mmScoreOptions[i] == '2,-3') {
				mmScoreOption.selected = true;
			}else if (value == 'megablast' && mmScoreOptions[i] == '1,-2') {
				mmScoreOption.selected = true;
			}		
	...
	if (value != 'tblastx') {
		...
		if (value == 'megablast') {
			gapcostOptions[0] = 'Existence: 0, Extension: 2';
			gapcostOptions[1] = 'Existence: 2, Extension: 2';
			gapcostOptions[2] = 'Existence: 1, Extension: 2';
			gapcostOptions[3] = 'Existence: 3, Extension: 1';
			gapcostOptions[4] = 'Existence: 2, Extension: 1';
			gapcostOptions[5] = 'Existence: 1, Extension: 1';
		}else if (value == 'blastn') {
